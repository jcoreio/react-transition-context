...
export default function featureLoader<S, A, P: Object>(
  ...
  const { getFeatures, getFeatureStates, featureId, render } = defaults(
    {},
    options,
    {
  ...
  function mergeProps(
    { feature, featureState }: PropsFromState,
    { dispatch }: PropsFromDispatch,
    props: P
  ): MergedProps {
    return {
      dispatch,
      featureState,
      children: render ? render({ feature, featureState, props }) : null,
    }
  }
